  ...
  try {
    ...
    const responseData = filtered_cases.map((caseData) => {
      return {
        ...
        // Money_Transaction_Ref: caseData.money_transaction_ref || null,
        ...
        // Bill_Payment_Status: caseData.bill_payment_status || null,
        Settlement_Phase: caseData.settlement_phase || null,
        // Cummulative_Credit: caseData.cummulative_credit || null,
        // Cummulative_Debit: caseData.cummulative_debit || null,
        Cummulative_Settled_Balance: caseData.cummulative_settled_balance || null,
        // Commissioned_Amount: caseData.commissioned_amount || null
      };
    })

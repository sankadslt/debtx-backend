...
//     const validStatuses = ["pending", "pending write off"]
...
//         .select("case_id case_current_status account_no bss_arrears_amount remark approve")
//         .skip(skip)
//         .limit(Number(limit)),
//     ]);
      ...
      { case_id: caseId },
      {
        $push: {
          ...
          case_status: {
            ...
            case_phase: "Pending Case Withdrawal",

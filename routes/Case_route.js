...
router.patch("/Update_Customer_Contacts", updateDrcCaseDetails);
 ...
 /**
 * @swagger
 * /api/case/AssignDRCToCaseDetails:
 *   post:
 *     summary: Retrieve detailed case information by case_id
 *     description: |
 *       Fetches all relevant case details using the provided `case_id`, including customer info, arrears, payment history, commission data, and more.
 *     tags:
 *       - Case Management
 *     requestBody:
 *       required: true
 ...
 *                       example: case_id is required
 *       404:
 *         description: No data available for the provided case_id
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                     description:
 *                       type: string
 *                       example: No data available for the provided case_id
 *       500:
 *         description: Internal server error
 *         content:
 *           application/json:
 ...
 *   post:
 *     summary: List DRC Mediation Board Cases with filters
 *     description: |
 *       Retrieves all cases handled by DRCs related to the Mediation Board. Supports filters like `case_status`, `From_DAT`, `TO_DAT`, `RTOM`, and `DRC`. Returns paginated results.
 *     tags:
 *       - Case Management
 *     requestBody:
 *       required: false
 ...
 *                       status:
 *                         type: string
 *                         example: "MB Fail with Pending Non-Settlement"
 *                       date:
 *                         type: string
 *                         format: date-time
 ...
 *     description: |
 *       Accepts a non-settlement request from the Mediation Board, updates the case status and current phase,
 *       and records the receiving officer and timestamp.
 *
 *       | Version | Date        | Description                                       | Changed By |
 *       |---------|-------------|---------------------------------------------------|------------|
 *       | 1.0     | 2025-06-24  | Updated to include mediation entry and receiver   | Dinithi    |
 *
 *     tags: [Case Management]
 *     requestBody:
 *       required: true
 ...
 *               recieved_by:
 *                 type: string
 *                 description: The name or ID of the officer who received the request.
 *                 example: "admin_user"
 *     responses:
 *       200:
 ...
 *                 message:
 *                   type: string
 *                   example: Mediation board data updated successfully
 *                 caseRecord:
 *                   type: object
 *                   properties:
 *                     case_id:
 ...
 *                             type: string
 *       400:
 *         description: Validation error or case status mismatch
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *     description: |
 *       Fetches request logs from the `User_Interaction_Log` collection based on filters such as delegate user ID, interaction type, date range, and recovery company.
 *
 *       | Version | Date        | Description                     | Changed By |
 *       |---------|-------------|---------------------------------|------------|
 *       | 01     | 2025-Mar-28 | Initial implementation           |  User      |
 *       | 02     | 2025-Jun-23 | Updated for filtering and response |          |
 *     tags: [Case Management]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *                       case_current_status:
 *                         type: string
 *                         example: "RO Negotiation FMB Pending"
 *                       Interaction_Log_ID:
 *                         type: integer
 *                         example: 351
 *                       Interaction_ID:
 ...
 *                         type: string
 *                         format: date-time
 *                         example: "2025-06-05T20:09:57.950Z"
 *       400:
 *         description: Validation error due to missing required fields.
 *         content:
 *           application/json:
 ...
 *       204:
 *         description: No matching interactions found.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *       | Version | Date        | Description                                | Changed By       |
 *       |---------|-------------|--------------------------------------------|------------------|
 *       | 01      | 2025-Jun-23 | Updated with actual response structure     | Dinusha Anupama  |
 *
 *     tags: [Case Management]
 *     requestBody:
 *       required: true
 ...
 *                   _id:
 *                     type: string
 *                     example: "67d7ae4ee93f2d3c3009dae1"
 *                   Interaction_Log_ID:
 *                     type: integer
 *                     example: 121
 *                   User_Interaction_Type:
 ...
 *                               type: string
 *                               format: date-time
 *                               example: "2025-06-04T20:39:07.888Z"
 *                   parameters:
 *                     type: object
 *                     properties:
 *                       case_id:
 ...
 *                     type: string
 *                     format: date-time
 *                     example: "2025-03-17T05:08:30.420Z"
 *                   doc_version:
 *                     type: integer
 *                     example: 1
 *                   case_details:
 ...
 *                       Validity_Period:
 *                         type: string
 *                         example: "2025-03-04T08:52:57.943Z - 2025-09-04T08:52:57.943Z"
 *                   Approve_Status:
 *                     type: string
 *                     example: "Unknown"
 *                   Request_Count:
 ...
 * /api/case/List_Active_RO_Requests_Mediation:
  *   post:
 *     summary: Retrieve all active RO (Recovery Officer) mediation requests
 *     description: |
 *       Retrieves all RO mediation requests from the `Template_RO_Request` MongoDB collection.
 *       This does not require any input filters. Returns all entries if available.
 *
 *       | Version | Date        | Description                  | Changed By       |
 *       |---------|-------------|------------------------------|------------------|
 *       | 1.0     | 2025-06-23  | Initial POST implementation  | Dinusha Anupama  |
 *
 *     tags: [RO Requests]
 *     requestBody:
 *       required: false
 ...
 *     responses:
 *       200:
 *         description: RO request details retrieved successfully.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: Ro request details retrieved successfully.
 *                 data:
 *                   type: array
 *                   items:
 *                     type: object
 ...
 *                       _id:
 *                         type: string
 *                         example: "667c5f94ad6d3449ac9fe65a"
 *                       ro_id:
 *                         type: number
 *                         example: 101
 *                       request_type:
 *                         type: string
 *                         example: "Mediation Letter"
 *                       request_comment:
 *                         type: string
 *                         example: "Please review this mediation letter."
 *                       status:
 *                         type: string
 *                         example: "Active"
 *                       created_at:
 ...
 *       404:
 *         description: No RO requests found in the database.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: No RO request found.
 *       500:
 *         description: Internal server error occurred while fetching RO requests.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *     description: |
 *       Fetches case details and related interaction log for mediation board acceptance request type.
 *
 *       | Version | Date        | Description                                                        | Changed By       |
 *       |---------|-------------|--------------------------------------------------------------------|------------------|
 *       | 01      | 2025-Mar-19 | Initial version for Mediation board interaction log case details.  | Dinusha Anupama  |
 *       | 02      | 2025-Jun-23 | Updated for filtering ro_requests by interaction log.              |                  |
 *
 *     tags: [Case Management]
 *     requestBody:
 *       required: true
 ...
 *     responses:
 *       200:
 *         description: Case details and ro_request retrieved successfully.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                         type: string
 *                         format: date-time
 *                         example: "2025-03-03T19:16:50.000Z"
 *       400:
 *         description: Validation error - Missing or incorrect parameters.
 *         content:
 *           application/json:
 ...
 *     description: |
 *       Submits a mediation board acceptance request, updates case status, extends DRC expiry if valid, and logs interactions.
 *
 *       | Version | Date        | Description                                         | Changed By       |
 *       |---------|-------------|-----------------------------------------------------|------------------|
 *       | 01      | 2025-Mar-19 | Submit mediation board acceptance request           | Dinusha Anupama  |
 *       | 02      | 2025-Jun-23 | Submit mediation board acceptance and update case   |                  |
 *     tags: [Case Management]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *     responses:
 *       200:
 *         description: Mediation Board Acceptance submitted successfully.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: "Mediation Board Acceptance Request submitted successfully."
 *
 *       204:
 *         description: Case not found.
 *         content:
 ...
 *                 message:
 *                   type: string
 *                   example: "create_by, Interaction_Log_ID, User_Interaction_Type, case_id, Interaction_ID, requestAccept are required."
 *
 *       405:
 *         description: DRC duration exceeded.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: "Cannot extend DRC expire_dtm beyond a total of 5 months."
 *
 *       404:
 ...
 *                 message:
 *                   type: string
 *                   example: "No matching Interaction_Log_ID found"
 *
 *       500:
 *         description: Internal server error.
 *         content:
 ...
 *     description: |
 *       This endpoint collects RO CPE data and updates the case details.
 *       It increments a counter to generate a unique `ro_cpe_collect_id` and updates
 *       the specified case with the provided details.
 *
 *       | Version | Date       | Description                        | Changed By         |
 *       |---------|------------|----------------------------------|--------------------|
 *       | 01      | 2025-Mar-19| Initial implementation of the API | H.B.R.P.Madushan   |
 *       | 02      | 2025-Jun-23| update Created_By                 | H.B.R.P.Madushan   |
 *
 *     tags:
 *       - RO CPE Collection
 *     requestBody:
 ...
 *                 data:
 *                   type: object
 *                   description: Updated case details including new RO CPE entry.
 *                   properties:
 *                     case_id:
 *                       type: integer
 *                       example: 1
 ...
 *                 summary: Sequence ID generation failed
 *                 value:
 *                   status: error
 *                   message: Internal Server Error
 *                   errors:
 *                     code: 500
 *                     description: Failed to generate ro_cpe_collect_id
 *               TaskCreationError:
 *                 summary: Task creation failed due to missing fields
 *                 value:
 *                   status: error
 *                   message: Internal Server Error
 *                   errors:
 *                     code: 500
 *                     description: Template_Task_Id and Created_By are required.
 *               UnexpectedError:
 *                 summary: Other unexpected errors
 *                 value:
 *                   status: error
 *                   message: Internal Server Error
 *                   errors:
...
/**
 * @swagger
 * /api/case/List_Settlement_Details_Owen_By_SettlementID_and_DRCID:
 *   post:
 *     summary: Get Settlement Details by Case ID and DRC ID
 *     description: |
 *       Fetches settlement details from `Case_settlements` collection by matching `settlement_id`s found in the case, filtered by `drc_id` and optionally `ro_id`.
 *
 *       | Version | Date        | Description                                     | Changed By       |
 *       |---------|-------------|-------------------------------------------------|------------------|
 *       | 01      | 2025-Jun-24 | Initial implementation                          |                  |
 *
 *     tags: [Case Management]
 *     requestBody:
 *       required: true
 ...
 *                 type: integer
 *                 example: 789
 *                 description: (Optional) ID of the Recovery Officer.
 *     responses:
 *       200:
 ...
 *                 message:
 *                   type: string
 *                   example: case id and drc id are a required parameters.
 *       404:
 *         description: No settlement details found for given criteria.
 *         content:
 *           application/json:
 *             schema:
 *               type: object
...
/**
 * @swagger
 * /api/case/listdownCaseDetailsByCaseId/{caseId}:
 *   get:
 *     summary: Get detailed case information by Case ID
 *     description: |
 *       Retrieves detailed case information using the provided `caseId`. 
 *       Includes general case details, basic information, DRC, RO negotiations, mediation board, settlement details, abnormal stop info, payment history, litigation records, and LOD info if available.
 *
 *       | Version | Date        | Description                        | Changed By        |
 *       |---------|-------------|------------------------------------|-------------------|
 *       | 1.0     | 2025-06-24  | Initial implementation             |    Dinithi        |
 *
 *     tags: [Case Management]
 *     parameters:
 *       - in: path
 ...
 *                         type: object
 *       400:
 *         description: Invalid case ID provided
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: Invalid case ID provided
 *       404:
 *         description: Case not found
 *         content:
 *           application/json:
 ...
 *                 message:
 *                   type: string
 *                   example: Case details not found for the provided ID
 *       500:
 *         description: Internal server error while fetching case details
 *         content:
 *           application/json:
 *             schema:
 *               type: object
...
router.get('/listdownCaseDetailsByCaseId/:caseId',listdownCaseDetailsByCaseId);
 ...
 /**
 * @swagger
 * /api/case/List_All_Cases:
 *   post:
 *     summary: List all filtered cases
 *     description: |
 *       Retrieves a list of cases based on various filters such as case status, RTOM, DRC, arrears band, service type, and created date range. Pagination is supported.
 *
 *       | Version | Date        | Description                   | Changed By       |
 *       |---------|-------------|-------------------------------|------------------|
 *       | 1.0     | 2025-06-24  | Initial endpoint definition   |   Dinithi        |
 *
 *     tags: [Case Management]
 *     requestBody:
 *       required: false
 ...
 *                         example: "2024-12-20T00:00:00.000Z"
 *       500:
 *         description: Server error while fetching case list
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: "There is an error fetching case list."
 */
 ...
 * /api/case/CaseStatus:
 *   get:
 *     summary: Retrieve active case statuses
 *     description: |
 *       Fetches all case status entries from the `Case_Phases` collection where `end_dtm` is null, indicating currently active statuses.
 *
 *       | Version | Date        | Description                   | Changed By       |
 *       |---------|-------------|-------------------------------|------------------|
 *       | 1.0     | 2025-06-23  | Initial endpoint definition   | Your Name        |
 *
 *     tags: [Case Management]
 *     responses:
 *       200:
 *         description: Successfully retrieved active case statuses
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                       _id:
 *                         type: string
 *                         example: "60c73b8f9f1b2c6f4f8a7a67"
 *       500:
 *         description: Server error while retrieving case statuses
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: "Error retrieving Case status."
 *                 errors:
 *                   type: object
 *                   properties:
 *                     code:
...
/**
 * @swagger
 * /api/case/List_DRC_Distribution_Rejected_Batches:
 *   get:
 *     summary: List rejected DRC distribution batches
 *     description: |
 *       Retrieves all DRC distribution batches where the last distribution status is marked as `batch_rejected`.
 *
 *       | Version | Date        | Description                            | Changed By       |
 *       |---------|-------------|----------------------------------------|------------------|
 *       | 1.0     | 2025-06-24  | Initial endpoint definition            |    Dinithi       |
 *
 *     tags: [DRC Distribution]
 *     responses:
 *       200:
 *         description: Successfully retrieved rejected DRC batches
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                           value: 15
 *       500:
 *         description: Server error while retrieving rejected batches
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *   post:
 *     summary: Get rejected batch summary by case_distribution_batch_id
 *     description: |
 *       Retrieves a summary of a rejected DRC batch including DRC commission rule and current arrears band using the given `case_distribution_batch_id`.
 *
 *       | Version | Date        | Description                                    | Changed By       |
 *       |---------|-------------|------------------------------------------------|------------------|
 *       | 1.0     | 2025-06-24  | Simplified response for rejected batch summary | Dinithi          |
 *
 *     tags: [DRC Distribution]
 *     requestBody:
 *       required: true
 ...
 *                   example: "case_distribution_batch_id is required."
 *       404:
 *         description: No rejected batch found
 *         content:
 *           application/json:
 *             schema:
 *               type: object
